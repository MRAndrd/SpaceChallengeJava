...
public class Simulation {
    ...
    public ArrayList<Rocket> loadU1(ArrayList<Item> _goods, ArrayList<Item> _loadItems) {
    ...
    public ArrayList<Rocket> loadU2(ArrayList<Item> _goods, ArrayList<Item> _loadItems) {
